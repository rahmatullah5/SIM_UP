...
<?php 
$per_hal=10;
$jumlah_record=mysql_query("SELECT COUNT(*) from su_order where id_user=$_SESSION[id_login]");
...
<table class="table table-hover">
	...
	if(isset($_GET['cari'])){
		...
		$brg=mysql_query("select * from su_order where id_user=$_SESSION[id_login] limit $start, $per_hal ");
	}
	$no=1;
