...
$id=mysql_real_escape_string($_GET['id']);
	...
	<?php
		...
		break;
		case 'profil':
		$det=mysql_query("select * from su_user where id_user=$_SESSION[id_login]")or die(mysql_error());
				while($d=mysql_fetch_array($det)){
				...
				<tr>
					...
					<td>Nama Penjual</td>
					<td><?php echo $d['nama_d'] ?> <?php echo $d['nama_b'] ?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><?php $az=mysql_query("select * from su_developer where id_user=$_SESSION[id_login]");$az1=mysql_fetch_array($az); echo $az1['tentang'] ?></td>
				</tr>
				...
				<tr>
					<td colspan="2">
						<a href="edit.php?a=user&id=<?php echo $d['id_user']; ?>" class="btn btn-warning">Edit Profile</a>
					</td>
				</tr>
			</table>
	<?php
