...
<?php 
$per_hal=10;
$jumlah_record=mysql_query("SELECT COUNT(*) from su_produk");
...
<table class="table table-hover">
	...
	if(isset($_GET['cari'])){
		...
		$brg=mysql_query("select * from su_produk limit $start, $per_hal");
	}
	$no=1;
	...
	<tr>
		...
		<?php 
			$xxx=0;
			$x=mysql_query("select sum(harga)*sum(stok) as total from su_produk group by id_produk");	
