	...
	switch ($_GET['a']) {
		case 'kategori':
			...
			<table class="table">
				<tr>
					<td></td>
					<td><input type="hidden" name="id" value="<?php echo $d['id_admin'] ?>"></td>
				</tr>
				<tr>
					<td>Username</td>
					<td><input type="text" class="form-control" name="user" value="<?php echo $d['user'] ?>"></td>
				</tr>
				<tr>
					<td>Password</td>
				...
				<tr>
					...
					<td>Nama Penjual</td>
					<td><input type="text" class="form-control" name="nama" value="<?php echo $d['nama'] ?>"></td></td>
				</tr>
				...
				<tr>
					...
					<td><textarea class="form-control" name="tentang" ><?php echo $d['tentang'] ?></textarea></td>
				</tr>
